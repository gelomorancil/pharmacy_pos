        ...
        <div class="tab-content mt-3" id="managementTabsContent">
            ...
            <div class="tab-pane fade show active" id="items" role="tabpanel">
                ...
                <ul class="nav nav-tabs mb-3" id="itemSubTabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="profile-sub-tab" data-toggle="tab" href="#profile-sub"
                            role="tab">Item Profile</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="items-sub-tab" data-toggle="tab" href="#items-sub" role="tab">Items</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="uom-sub-tab" data-toggle="tab" href="#uom-sub" role="tab">Unit of
                            Measure</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="client-sub-tab" data-toggle="tab" href="#client-sub"
                            role="tab">Clients</a>
                    </li>
                </ul>
                                    ...
                                    <form>
                                        ...
                                        <div class="card-footer">
                                            <button type="button" class="btn btn-primary"
                                                id="save_item_profile">Submit</button>
                                ...
                                <div class="card">
                                    ...
                                    <form>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group w-100">
                                                        ...
                                                        <input type="text" id="unit" class="form-control inpt"
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <button type="button" class="btn btn-danger" id="delete_unit"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-4">
                                                    <div class="form-group w-100">
                                                        ...
                                                        <input type="text" id="code" class="form-control inpt"
