                    ...
                    data.items.forEach(function (row) {
                        let tr = `
                            <tr>
                                ...
                                <td>
                                    <input type="number" class="form-control form-control-xs received-pcs" 
                                        min="0" value="">
                                </td>
                                <td>
                                    <input type="number" class="form-control form-control-xs damaged-pcs" 
                                        min="0" value="">
                                </td>
                                <td>
...
$('#approve-delivery').click(function () {
    ...
    $('#e-order_table tbody tr').each(function () {
        let $tr = $(this);
        let data = {
            unit_id: $tr.find('td[data-unit-id]').data('unit-id') || null,
            unit_of_measure: $tr.find('td[data-unit-id]').text().trim(),
            qty: $tr.find('td').eq(1).text().trim(),
            pcs: $tr.find('td').eq(2).text().trim(),
